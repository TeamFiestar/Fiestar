...
import com.TeamFiestar.Fiestar.email.model.mapper.EmailMapper;
...
public class EmailServiceImpl implements EmailService{
	...
	private final JavaMailSender mailSender; // 자바에서 메일 보낼때 사용하는 메일 샌더
	   ...
	   public int sendEmail(String htmlName, String email) {
	       //6자리 난수 인증번호 생성
	        ...
	        try {
	           ...
	           switch(htmlName) {
	           case "signup" : subject = "[Fiestar] 회원가입 인증 번호 입니다."; break;
	           }
