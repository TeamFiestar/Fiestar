...
//      // e -> 발생한 이벤트 정보를 담고 있는 객체 ,  e.target -> 이벤트가 일어난 요소 
//      let itemCount = e.target.previousElementSibling;
//      let cartNo = e.target.parentElement.dataset.cartNo; // Assuming you have an attribute for the item ID
      
//      // Make an AJAX call to update the server-side data
//      updateData(cartNo, Number(itemCount.innerText) + 1, () => {
//        itemCount.innerText = Number(itemCount.innerText) + 1;
//        clacPrice(e.target);
//        checkedPrice();
//      });
