...
// const defaultPriceList = document.querySelectorAll(".default-price");
...
for(let i=0; i<plusList.length; i++) {
   ...
   plusList[i].addEventListener("click", e => {
      ...
      let eachPrice = e.target.nextElementSibling;
      console.log(eachPrice.innerText);
      ...
      let eachPrice = itemCount.innerText * Number(eachPriceList[i].innerText);
